...
function record_line(line_array, event::String, state0, statef, current_time , mining_ship, control; rendez_flag::String="none")
    #new_line = DataFrame()
    ...
    elseif event == "rendezvous"
        ...
        before_line = string(mining_ship.ship_ID, " ", event_ID, " ") * join(state, " ") * string(" ", mining_ship.mass_total) * "\n"
        ...
        after_line  = string(mining_ship.ship_ID, " ", event_ID, " ") * join(state, " ") * string(" ", mining_ship.mass_total) * "\n"
