...
x_burn_arc_1 = calculate_rendezvous(x₀⁺, x_target, Δt; m0=m, μ=GTOC12.μ_☉, dt=24*3600)
r_burn_arc_1 = getindex.(x_burn_arc_1', 1:3)'

# Find asteroid with closest inclination
_, ID_min = findmin((GTOC12.asteroid_df.inc .- asteroid.inc ))
asteroid_2 = Asteroid(ID_min)
